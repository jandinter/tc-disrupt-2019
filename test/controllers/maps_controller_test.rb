...
class MapsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create map" do
    assert_difference('Map.count') do
      post maps_url, params: { map: { lat: @map.lat, location: @map.location, long: @map.long, radius: @map.radius, widget: @map.widget } }
    end
  ...
  test "should update map" do
    patch map_url(@map), params: { map: { lat: @map.lat, location: @map.location, long: @map.long, radius: @map.radius, widget: @map.widget } }
